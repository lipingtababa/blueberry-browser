...
const UserMessage: React.FC<{ content: string; messageId?: string }> = ({
  content,
  messageId,
}) => (
  <div
...
const ConversationTurnComponent: React.FC<{
  ...
  <div className="pt-12 flex flex-col gap-8">
    {turn.user && (
      <UserMessage content={turn.user.content} messageId={turn.user.id} />
    )}
    {turn.assistant && (
      <AssistantMessage
...
export const Chat: React.FC = () => {
  ...
  console.log(
    "[CHAT COMPONENT] Conversation turns:",
    conversationTurns.length,
    conversationTurns,
  );
  console.log(
    "[CHAT COMPONENT] showLoadingAfterLastTurn:",
        ...
        {showRecordings ? (
          ...
          <div className="h-full px-4 py-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <Button onClick={closeRecordingsList} variant="ghost">
                Close
              </Button>
            </div>
                ...
                {recordings.map((recording) => (
                  ...
                  >
                    ...
                    <div className="text-xs text-muted-foreground mb-3">
                      ...
                      {recording.metadata?.manualSteps
                        ? ` • ${recording.metadata.manualSteps} manual steps`
                        : ""}
                      {recording.metadata?.targetSite &&
                        ` • ${new URL(recording.metadata.targetSite).hostname}`}
                    </div>
