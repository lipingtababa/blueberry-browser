...
interface TopBarAPI {
  ...
  recorderAddManualStep: (
    description: string,
  ) => Promise<{ success: boolean; error?: string }>;
  recorderGetState: () => Promise<{
    success: boolean;
    state?: RecorderState;
    error?: string;
  }>;
  recorderGetRecordings: () => Promise<{
    success: boolean;
    recordings?: Recording[];
    error?: string;
  }>;
  ...
  sessionHasValid: (
    domain: string,
    name?: string,
  ) => Promise<{ success: boolean; hasValid?: boolean; error?: string }>;
  sessionDelete: (
    domain: string,
    name?: string,
  ) => Promise<{ success: boolean; error?: string }>;
